...
constexpr char const *ACTION_MOUSE_MOVE = "MOUSE_MOVE";
constexpr char const *ACTION_MOUSE_SELECT = "SELECT";
...
constexpr char const *ACTION_SCROLL_DOWN = "SCROLL_DOWN";
constexpr char const *ACTION_SCROLL_UP = "SCROLL_UP";
